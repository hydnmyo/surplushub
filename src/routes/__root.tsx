...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SurplusHub — Circular B2B Marketplace for Surplus Materials" },
      {
        name: "description",
        content:
          "SurplusHub connects Myanmar businesses that have surplus materials with businesses that need them.",
      },
      { name: "author", content: "SurplusHub" },
