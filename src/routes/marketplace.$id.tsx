                ...
                <DialogContent>
                  ...
                  <div className="grid gap-3">
                    ...
                    <div>
                      ...
                      <Input className="mt-1.5" defaultValue={listing.price ?? 0} />
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <Label>Pickup / delivery</Label>
                        <Input className="mt-1.5" defaultValue="Self pickup" />
                      </div>
                      <div>
                        <Label>Preferred date</Label>
                        <Input className="mt-1.5" type="date" defaultValue="2026-08-20" />
                      </div>
                    </div>
                    <div>
                      <Label>Message</Label>
                      <Textarea className="mt-1.5" placeholder="Tell the seller how you plan to use the material…" />
                    </div>
                  </div>
                  <DialogFooter>
