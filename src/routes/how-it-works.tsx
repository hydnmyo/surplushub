  ...
  head: () => ({
    meta: [
      { title: "How It Works — Sell, Discover and Verify Surplus | SurplusHub" },
      {
        name: "description",
        content:
          "How SurplusHub works for sellers, buyers and transactions: list surplus, discover materials, negotiate, verify with a transaction QR.",
      },
      { property: "og:title", content: "How SurplusHub Works" },
      {
        property: "og:description",
        content: "Surplus → Discovery → AI Match → Connect → Deal → Verify → Reuse.",
      },
    ],
  }),
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        ...
        {[
          {
            title: "For sellers",
            items: [
              "Create a company profile and get verified",
              "Upload surplus with photos, quantity and condition",
              "Let Loopi draft the listing and estimate price",
              "Receive inquiries and offers",
          ...
          },
          {
            ...
            items: [
              ...
              "Negotiate or request an inspection",
              "Complete the deal with a transaction QR",
          ...
          },
          {
            ...
            items: [
              "Business verification and document review",
              "Listing moderation and reporting",
              "Transaction records and status tracking",
              "Category management",
      ...
      <div className="surface-card mt-12 p-7">
        ...
        <h2 className="mt-3 font-display text-2xl font-semibold">
          Every deal has a tracked status trail
        </h2>
        <ol className="mt-5 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
          {TX_FLOW.map((s, i) => (
            <li key={s} className="rounded-xl border border-border bg-secondary/50 p-3 text-sm">
              <span className="mr-2 font-display font-semibold text-primary">{i + 1}</span>
              {s}
            </li>
          ))}
        </ol>
